            ...
            <div className='catagoryContainer w-screen w-screenflex-row flex h-full'>
                <div className="flex flex-col items-center justify-start w-2/5 h-full m-4">
                    <div className='h-1/5 w-full m-4'>
                        <MenuItem drinkName={"Black Tea Latte"} drinkImage={defualtDrinkImg} altTxt={"Test Drink"} thisOnClick={goToCustomization}/>
                    </div>
                    <div className='h-1/5 w-full m-4'>
                        <MenuItem drinkName={"Fresh Milk with Herbal Jelly"} drinkImage={defualtDrinkImg} altTxt={"Test Drink"} thisOnClick={goToCustomization}/>
                    </div>
                    <div className='h-1/5 w-full m-4'>
                        <MenuItem drinkName={"Macha Tea Latte"} drinkImage={defualtDrinkImg} altTxt={"Test Drink"} thisOnClick={goToCustomization}/>
                    </div>
                    <div className='h-1/5 w-full m-4'>
                        <MenuItem drinkName={"Strawberry Macha Latte"} drinkImage={defualtDrinkImg} altTxt={"Test Drink"} thisOnClick={goToCustomization}/>
                    </div>
                </div>
                <div className="flex flex-col items-center justify-start w-2/5 h-full m-4">
                    <div className='h-1/5 w-full m-4'>
                        <MenuItem drinkName={"Earl Grey Tea Latte"} drinkImage={defualtDrinkImg} altTxt={"Test Drink"} thisOnClick={goToCustomization}/>
                    </div>
                    <div className='h-1/5 w-full m-4'>
                        <MenuItem drinkName={"Green Tea Latte"} drinkImage={defualtDrinkImg} altTxt={"Test Drink"} thisOnClick={goToCustomization}/>
                    </div>
                    <div className='h-1/5 w-full m-4'>
                        <MenuItem drinkName={"Oolong Tea Latte"} drinkImage={defualtDrinkImg} altTxt={"Test Drinkx`"} thisOnClick={goToCustomization}/>
                    </div>
                    <div className='h-1/5 w-full m-4'>
                        <MenuItem drinkName={"Thai Tea Latte"} drinkImage={defualtDrinkImg} altTxt={"Test Drink"} thisOnClick={goToCustomization}/>
                    </div>
                </div>
