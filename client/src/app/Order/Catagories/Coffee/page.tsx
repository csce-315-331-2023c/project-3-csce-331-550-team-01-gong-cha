            ...
            <div className='catagoryContainer w-screen w-screenflex-row flex h-full'>
                <div className="flex flex-col items-center justify-start w-2/5 h-full m-4">
                    <div className='h-1/5 w-full m-4'>
                        <MenuItem drinkName={"Coffee Milk Tea"} drinkImage={defualtDrinkImg} altTxt={"Test Drink"} thisOnClick={goToCustomization}/>
                    </div>
                    <div className='h-1/5 w-full m-4'>
                        <MenuItem drinkName={"Milk Coffee"} drinkImage={defualtDrinkImg} altTxt={"Test Drink"} thisOnClick={goToCustomization}/>
                    </div>
                </div>
                <div className="flex flex-col items-center justify-start w-2/5 h-full m-4">
                    <div className='h-1/5 w-full m-4'>
                        <MenuItem drinkName={"Dolce Milk Coffee"} drinkImage={defualtDrinkImg} altTxt={"Test Drink"} thisOnClick={goToCustomization}/>
                    </div>
                    <div className='h-1/5 w-full m-4'>
                        <MenuItem drinkName={"Milk Foam Balck Coffee"} drinkImage={defualtDrinkImg} altTxt={"Test Drink"} thisOnClick={goToCustomization}/>
                    </div>
                </div>
