...
export default function Order() {
    ...
    useEffect(() => {
          ...
          fetch('http://18.223.2.65:5000/drinks-from-category/4') // Replace with the actual API endpoint URL
            .then((response) => {
              if (!response.ok) {
                // alert("did not pass");
      ...
      , []);
    return (
      <main className="backgroundS bg-slate-200 bg-cover w-screen flex flex-col h-auto">
